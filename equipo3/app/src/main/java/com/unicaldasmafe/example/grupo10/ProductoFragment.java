...
public class ProductoFragment extends Fragment {
    ...
    private ImageView img_producto_imagen;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        img_producto_imagen=root.findViewById(R.id.img_producto_imagen);
        ...
        btn_producto_guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                producto.put("url", urlImage);
				//producto.put("detalles", detalle);
                ...
                db.collection("productos")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                ...
                                img_producto_imagen.setImageDrawable(getActivity().getDrawable(R.drawable.logopeque));
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(getActivity(), "Error al crear producto", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
        ...
        if (requestCode == OPEN_GALLERY) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    img_producto_imagen.setImageBitmap(bitmap);
                } catch (IOException e) {
                    e.printStackTrace();
                }
